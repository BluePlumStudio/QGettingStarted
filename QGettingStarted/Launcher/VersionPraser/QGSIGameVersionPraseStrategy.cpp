...
QGSIGameVersionPraseStrategy::QGSIGameVersionPraseStrategy(const int minimunLaunchVersion) :mMinimunLaunchVersion(minimunLaunchVersion)
{

}

QGSIGameVersionPraseStrategy::~QGSIGameVersionPraseStrategy()
{

}


bool QGSIGameVersionPraseStrategy::praseId(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseArguments(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseMainClass(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseInheritsFrom(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseJar(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseAssetIndex(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseAssets(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseLibraries(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseDownloads(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseLogging(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseType(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseTime(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseReleaseTime(GameVersion & version, QJsonObject & object)const
{
...
bool QGSIGameVersionPraseStrategy::praseMinimumLauncherVersion(GameVersion & version, QJsonObject & object)const
{
...
/**/
Rules QGSIGameVersionPraseStrategy::praseRules(QJsonArray & arrayRules)const
{
	Rules rules;
...
QStringList QGSIGameVersionPraseStrategy::praseValue(QJsonValue & valueValue)const
{
	QStringList value;
...
/**/
Library QGSIGameVersionPraseStrategy::praseLibrary(QJsonObject & object)const
{
	Library library;
