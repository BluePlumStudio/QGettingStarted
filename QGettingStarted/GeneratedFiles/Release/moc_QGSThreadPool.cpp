...
QT_MOC_LITERAL(1, 14, 14), // "threadPoolFull"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "QGSThreadPool\0threadPoolFull\0"
};
...
void QGSThreadPool::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->threadPoolFull(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (QGSThreadPool::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QGSThreadPool::threadPoolFull)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void QGSThreadPool::threadPoolFull()
{
